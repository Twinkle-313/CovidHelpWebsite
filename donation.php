...
<br><center><a href="discussion.php?category=<?php echo 'Donation' ?>"><button class="btn"><i class="fa fa-plus-circle"></i> ADD NEW POST</button></a></center>
<?php
    include '_dbconnect.php';
    $sql = "select * from Donation order by time DESC"; 
