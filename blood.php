...
<br><center><a href="discussion.php?category=<?php echo 'Blood' ?>"><button class="btn"><i class="fa fa-plus-circle"></i> ADD NEW POST</button></a></center>
<?php
//$uid = $_GET['userid'];
include '_dbconnect.php';
    //echo 'data3';
    $sql = "SELECT * FROM `Blood` order by time DESC";
